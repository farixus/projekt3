...
1. First of all we needed to discover ip address of victim. Therefor we used nmap.
...
- the next step is use elasticsearch exploit to get shell. We used exploit/multi/elasticsearch/search_groovy_script options:
